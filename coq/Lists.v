...
Theorem app_assoc : forall l1 l2 l3 : natlist,
  (l1 ++ l2) ++ l3 = l1 ++ (l2 ++ l3).
Proof.
  intros l1 l2 l3. induction l1 as [|h t].
  Case "l1 = nil".
    simpl. reflexivity.
  Case "l1 = h :: t".
...
Proof.
  ...
  Case "l = []".
    reflexivity.
  Case "l = n :: l'".
    (* simpl. rewrite -> snoc_length. rewrite -> IHl'. reflexivity. *)
...
Proof.
  ...
  Case "l = h :: t". simpl. rewrite -> IHt. simpl. reflexivity.
Qed.  
...
Proof.
  ...
  simpl. rewrite -> IHt. rewrite -> distr_snoc. reflexivity.
Qed.
...
Proof.
  ...
  trivial. rewrite -> IHt. simpl. reflexivity.
Qed.
(** [] *)
